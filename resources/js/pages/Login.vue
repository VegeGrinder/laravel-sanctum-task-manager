        ...
        <div class="bg-white shadow-lg rounded-lg px-8 pt-6 pb-8 mb-2 flex flex-col">
            ...
            <form method="post" @submit.prevent="handleLogin">
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="username" type="text" v-model="form.email" required />
                ...
                <div class="flex items-center justify-between">
                    ...
                    <router-link class="inline-block align-baseline font-bold text-sm text-blue hover:text-blue-darker" to="register">
                        Sign Up
                    </router-link>
                </div>
            </form>
